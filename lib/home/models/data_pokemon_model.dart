...
DataPokemonModel dataPokemonModelFromJson(String str) => DataPokemonModel.fromJson(json.decode(str));

String dataPokemonModelToJson(DataPokemonModel data) => json.encode(data.toJson());
...
class DataPokemonModel {
  ...
  factory DataPokemonModel.fromJson(Map<String, dynamic> json) => DataPokemonModel(
